 ...
 */
package com.baseProject.android.util.persianCalendar.gwt;

import com.baseProject.android.util.persianCalendar.utils.PersianCalendarConstants;
import com.baseProject.android.util.persianCalendar.utils.PersianCalendarUtils;
...
public class GWTPersianCalendar extends Date {
    ...
    public void setPersianDate(int persianYear, int persianMonth, int persianDay) {
        ...
        setTime(convertToMillis(PersianCalendarUtils.persianToJulian(this.persianYear > 0 ? this.persianYear
    ...
    /**
     * <pre>
     *    use <code>{@link com.baseProject.android.util.persianCalendar.PersianDateParser}</code> to parse string
     *    and get the Persian Date.
     * </pre>
     *
     * @param dateString
     * @see com.baseProject.android.util.persianCalendar.PersianDateParser
     */
    ...
    /**
     * assign delimiter to use as a horizontal_separator of date fields.
     *
     * @param delimiter
     */
