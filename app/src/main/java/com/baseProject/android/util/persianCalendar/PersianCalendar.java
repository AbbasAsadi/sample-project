 ...
 */
package com.baseProject.android.util.persianCalendar;
...
public class PersianCalendar extends GregorianCalendar {
    ...
    public String getShortDate() {
        return "" + formatToMilitary(get(YEAR)) + delimiter + formatToMilitary(get(MONTH)) + delimiter
                + formatToMilitary(get(DAY_OF_MONTH));
    }
